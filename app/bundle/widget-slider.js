...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Applications/XAMPP/xamppfiles/htdocs/pagekit2/packages/pagekit/theme-one/app/components/widget-slider.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports) {
	...
	//                     <label><i>Zuerst den Titel, dann der Link!</i></label>
	//                     <p>
	...
	//             <div class="uk-form-row">
	//                 <label for="form-bgimage" class="uk-form-label">{{ 'Slider Bild' | trans }}</label>
	//                 <div class="uk-form-controls">
	...
	window.Widgets.components['theme-one-slider:slider'] = module.exports;
