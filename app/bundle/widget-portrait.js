...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Applications/XAMPP/xamppfiles/htdocs/pagekit2/packages/pagekit/theme-one/app/components/widget-portrait.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports) {
	...
	//             <div class="uk-form-row">
	//               <label for="form-slide" class="uk-form-label">Rechts</label>
	//               <div class="uk-form-controls">
	//                   <p class="uk-form-controls-condensed uk-form-width-large"><input type="checkbox" v-model="widget.data.right"></input> {{ 'Rechts ausrichten' | trans }}</p>
	//                   <br>
	//               </div>
	//             </div>

	//             <div class="uk-form-row">
	//               <label for="form-slide" class="uk-form-label">Hintergrund Farbe</label>
	//               <div class="uk-form-controls">
	//                   <input id="form-title" class="uk-form-width-large" type="text" name="title" v-model="widget.data.bgcolor" placeholder="#fafafa" source="{{@ widget.data.bgcolor }}">
	//                   <br>
	//               </div>
	//             </div>
	...
	window.Widgets.components['theme-one-portrait:portrait'] = module.exports;
