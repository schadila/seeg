...
<h1 class="uk-center">Intern</h1>
<?php if ($user->isAuthenticated()): ?>

<?= __('Hi %username%', ['%username%' => $user->username]) ?>, du bist jetzt angemeldet.<br><br>
<a class="uk-button" href="<?= $view->url('@user/logout', ['redirect' => $redirect]) ?>"><?= __('Logout') ?></a>
